...
const ProductDetails = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-pink-200 text-black">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col justify-between">
                        <div>
                            ...
                            <p className="text-pink-500 leading-relaxed mb-6">
                        ...
                        <div className="flex gap-4 mt-6">
                            <button
                                ...
                                className="flex-1 bg-pink-500 cursor-pointer hover:bg-pink-600 text-white text-2xl py-3 rounded-md transition-all focus:outline-none shadow-lg"
                            >
                                Add to Cart
                            </button>
                            <button
